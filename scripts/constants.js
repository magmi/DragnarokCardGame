  ...
  [
    {
      ...
      attacks: [
        { id: 1, name: 'Maul', type: 'attack', value: 8 },
        { id: 2, name: 'Guard', type: 'defend', value: 10 },
      ],
      path: [2, 1, 1, 1],
      expValue: 40,
    },
      ...
      attacks: [
        { id: 1, name: 'Maul', type: 'attack', value: 10 },
        { id: 2, name: 'Guard', type: 'defend', value: 7 },
      ],
      path: [1, 2, 1, 1],
      expValue: 40,
    },
  ...
  [
    {
      ...
      attacks: [
        { id: 1, name: 'Bite 1', type: 'attack', value: 12 },
        { id: 2, name: 'Hex', type: 'special', weak: 2 },
        { id: 3, name: 'Bite 2', type: 'attack', value: 10 },
      ],
      path: [2, 1, 3, 1],
      expValue: 50,
    },
    {
      ...
      attacks: [
        { id: 1, name: 'Chomp 1', type: 'attack', value: 11 },
        { id: 2, name: 'Spiked Fury', type: 'special', strength: 1 },
        { id: 3, name: 'Chomp 2', type: 'attack', value: 13 },
      ],
      path: [1, 2, 3, 1, 3],
      expValue: 50,
    },
  ...
  [
    {
      ...
      attacks: [
        { id: 1, name: 'Attack', type: 'attack', value: 15 },
        { id: 2, name: 'Bite', type: 'attack', value: 12 },
        { id: 3, name: 'Crushing Tide', type: 'special', weak: 5 },
        { id: 4, name: 'Brace', type: 'defend', value: 12 },
        { id: 5, name: 'Slash', type: 'attack', value: 14 },
      ],
      path: [1, 2, 3, 4, 5, 2, 5],
      expValue: 60,
    },
    {
      ...
      attacks: [
        { id: 1, name: 'Corroding Breath', type: 'special', vulnerable: 4 },
        { id: 2, name: 'Dragon Bite', type: 'attack', value: 13 },
        { id: 3, name: 'Tail Swipe', type: 'attack', value: 11 },
        { id: 4, name: 'Bronze Claw', type: 'attack', value: 14 },
  ...
  [
    ...
    },
    {
      ...
      attacks: [
        ...
        { id: 4, name: 'Corroding Breath', type: 'special', vulnerable: 4 },
        { id: 5, name: 'Bronze Might', type: 'special', strength: 1 },
  ...
  [
    {
      ...
      attacks: [
        ...
        { id: 4, name: 'Searing Mark', type: 'special', vulnerable: 3, weak: 3 },
        { id: 5, name: 'Dragon Fury', type: 'special', strength: 3 },
        { id: 6, name: 'Ember Shield', type: 'defend', value: 15 },
        { id: 7, name: 'Soul Drain', type: 'special', weakenStrength: 1 },
      ],
      path: [5, 1, 2, 4, 7, 2, 6, 1, 3],
      expValue: 200,
    },
  ],
